...
Python version 3.8 or above is required. Type `python -V` (or `python3 -V` on Mac) at your shell prompt and press enter to see what version of Python is installed on your system.
